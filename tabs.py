...
# rtsp://192.168.1.250:554/cam/realmonitor?channel=1&subtype=0&unicast=true&proto=Onvif
import cv2
user = "admin"
password = "admin123"
url = "rtsp://192.168.1.250:554/cam/realmonitor?channel=1&subtype=1&unicast=true&proto=Onvif"
url = url[:7] + f'{user}:{password}@' + url[7:]
print(url)
cap = cv2.VideoCapture("rtsp://admin:admin123@192.168.1.250:554/cam/realmonitor?channel=1&subtype=1&unicast=true&proto=Onvif")
